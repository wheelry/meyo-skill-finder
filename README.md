...
> 一键直达：[meyo-skill-finder](https://www.meyo123.com/skill)

**别让 Agent 在 Skill 市场里碰运气。**

[meyo-skill-finder](https://www.meyo123.com/skill) 不看 Skill 怎么自述，只看它在真实任务里怎么跑。通过社区百万技能实测贴、横向对比和多路召回机制，把 Agent 的当前需求匹配到经战绩验证的 Skill。

一句话：告诉 Agent 你想做什么，它从 [Meyo 社区](https://meyo.sankuai.com) 50000+ Skill 里找到最合适的，确认后一键安装。

![meyo-skill-finder](images/hero.png)
...
meyo-skill-finder 要解决的就是**发现**和**信任**两件事。

![Skill 市场的问题](images/why.png)

## How it works

Meyo 社区积累了百万量级的真实用户实测数据——用户在真实任务中运行 Skill 并记录下结果。meyo-skill-finder 基于这些数据，用 AI Search 把 Agent 的自然语言需求匹配到经过实战验证的 Skill 上。

```
你描述一个真实任务
       |
       v
meyo-skill-finder 理解意图，改写为可检索 query
       |
       v
...
```bash
git clone https://github.com/wheelry/meyo-skill-finder.git \
  ~/.catpaw/skills/meyo-skill-finder
```

### Use

用自然语言描述你的任务，meyo-skill-finder 会理解意图并匹配：
...
![三步开始使用](images/quickstart.png)

## What makes it different

**不靠 description，靠真实战绩。** 传统 Skill 搜索依赖创作者自己写的描述，meyo-skill-finder 用社区真实运行结果来验证和排序。
...
| 任务 | 其他 Finder | meyo-skill-finder | 差异 |
|------|------------|-------------------|------|
...
![实例对比](images/comparison.png)

## Try it now

在线体验 meyo-skill-finder：输入你的真实需求，调用 AI 语义搜索为你匹配 Skill。

[![在线体验](images/try-and-cta.png)](https://www.meyo123.com/skill)
...
- [了解 meyo-skill-finder](https://www.meyo123.com/skill)
